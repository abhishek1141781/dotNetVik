...
namespace webapiexam.Controllers
{
    ...
    {
        private readonly ExamwebapiContext _context;

        public EmployeesController(ExamwebapiContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Employees != null ? 
                          ...
                          Problem("Entity set 'ExamwebapiContext.Employees'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ExamwebapiContext.Employees'  is null.");
            }
            var employee = await _context.Employees.FindAsync(id);
            if (employee != null)
            {
