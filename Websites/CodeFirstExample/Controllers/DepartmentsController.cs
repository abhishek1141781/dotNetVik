...
namespace CodeFirstExample.Controllers
{
    ...
    {
        private readonly ActsJune23CodeFirstContext _context;

        public DepartmentsController(ActsJune23CodeFirstContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Departments != null ? 
                          ...
                          Problem("Entity set 'ActsJune23CodeFirstContext.Departments'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ActsJune23CodeFirstContext.Departments'  is null.");
            }
            var department = await _context.Departments.FindAsync(id);
            if (department != null)
            {
