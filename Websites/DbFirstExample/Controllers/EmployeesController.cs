...
namespace DbFirstExample.Controllers
{
    ...
    {
        private readonly ActsJune23Context _context;

        public EmployeesController(ActsJune23Context context)
        {
            _context = context;
        }
        ...
        //{
        //    var x = _context.Employees.Include(e => e.DeptNoNavigation);
        //    return View(x.ToList());
        //}
        public async Task<IActionResult> Index()
        {
            var actsJune23Context = _context.Employees.Include(e => e.DeptNoNavigation);
            return View(await actsJune23Context.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ActsJune23Context.Employees'  is null.");
            }
            var employee = await _context.Employees.FindAsync(id);
            if (employee != null)
            {
