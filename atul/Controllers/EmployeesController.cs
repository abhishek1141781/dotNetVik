...
namespace atul.Controllers
{
    public class EmployeesController : Controller
    {
        private readonly ActsContext _context;

        public EmployeesController(ActsContext context)
        {
            _context = context;
        }
        ...
        {
            var actsContext = _context.Employees.Include(e => e.DeptNoNavigation);
            return View(await actsContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ActsContext.Employees'  is null.");
            }
            var employee = await _context.Employees.FindAsync(id);
            if (employee != null)
            {
