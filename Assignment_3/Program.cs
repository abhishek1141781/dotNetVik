...
namespace Assignment_3_inheritance  
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Employee o1 = new Employee("Amol", 3465, 10);
            //Employee o2 = new Employee("Amol", 3465);
        }
    }
    ...
    public class Employee
    {
        ...
        public Employee(String? name = null, decimal basicSalary = 0, short deptNo = 0)
        {
            ...
            this.deptNo = deptNo;
            //this is only possible in this as the `empNo` has no setter in it's property method
        ...
        public short DeptNo
        {
            ...
            {
                if (value <= 0)
                    throw new ArgumentOutOfRangeException("Enter DeptNo greater than 0");
